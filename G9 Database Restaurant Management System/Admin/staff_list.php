...
<form class="form-inline" action="staffRegister.php" method="post">
  <label for="username">Register Staff:</label>
  <input type="string" id="username" name="username" placeholder="Enter Username" />
  <input type="string" id="password" name="password" placeholder="Enter Password" />
